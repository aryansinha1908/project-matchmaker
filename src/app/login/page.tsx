  ...
  return (
    <PageContainer className="flex items-center justify-center min-h-[calc(100vh-4rem)] py-12">
      <div className="relative">
        ...
        <Card className="w-[340px] h-[340px] border shadow-xl flex flex-col justify-center">
          <CardHeader className="text-center space-y-4 pb-4">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-lg border">
              <GithubIcon />
            </div>
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="text-sm">
                Find teammates for hackathons, projects, startups, and open
